...
*/
  ...
  // [ C3 ]
  loadImage("Cyclomatus1.png");
  loadImage("Cyclomatus2.png");
  loadImage("Cyclomatus3.png");
  loadImage("Cyclomatus4.png");
...
//press and hold the up and down keys
  ...
  if(mouseX < windowWidth/4 && mouseX > 0 && mouseY < windowHeight/3 && mouseY > 0) {
...
//Click to create a new sprite with random speed
  ...
  if(mouseX < windowWidth/2 && mouseX > windowWidth/4 && mouseY < windowHeight/3 && mouseY > 0) {
...
//click to create new sprites
  ...
  if(mouseX < (windowWidth/4)*3 && mouseX > windowWidth/2 && mouseY < windowHeight/3 && mouseY > 0) {
...
//Click to create a new sprite with random speed
  ...
  if(mouseX < windowWidth && mouseX > (windowWidth/4)*3 && mouseY < windowHeight/3 && mouseY > 0) {
...
//Click to create a new sprite with random speed
  ...
  if(mouseX < windowWidth/4 && mouseX > 0 && mouseY < (windowHeight/3)*2 && mouseY > windowHeight/3) {
...
//Click to create a new sprite with random speed
  ...
  if(mouseX < windowWidth/2 && mouseX > windowWidth/4 && mouseY < (windowHeight/3)*2 && mouseY > windowHeight/3) {
...
// [ B3 ] ZOOM ZOOM
  ...
  if(mouseX < (windowWidth/4)*3 && mouseX > windowWidth/2 && mouseY < (windowHeight/3)*2 && mouseY > windowHeight/3) {
...
//Click to create a new sprite with random speed
  ...
  if(mouseX < windowWidth && mouseX > (windowWidth/4)*3 && mouseY < (windowHeight/3)*2 && mouseY > windowHeight/3) {
...
//Click to create a new sprite with random speed
  ...
  if(mouseX < windowWidth/4 && mouseX > 0 && mouseY < windowHeight && mouseY > (windowHeight/3)*2) {
...
//click to create new sprites
  ...
  if(mouseX < windowWidth/2 && mouseX > windowWidth/4 && mouseY < windowHeight && mouseY > (windowHeight/3)*2) {
...
//Click to create a new sprite with random speed
  ...
  if(mouseX < (windowWidth/4)*3 && mouseX > windowWidth/2 && mouseY < windowHeight && mouseY > (windowHeight/3)*2) {
...
//Click to create a new sprite with random speed
  ...
  if(mouseX < windowWidth && mouseX > (windowWidth/4)*3 && mouseY < windowHeight && mouseY > (windowHeight/3)*2) {
